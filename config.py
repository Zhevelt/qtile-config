...
myBrowser = "firefox --private-window" # My browser of choice
...
groups = [Group("OFFICE1", layout='monadtall'),
          Group("OFFICE2", layout='monadtall'),
          Group("MUSIC", layout='monadtall'),
          Group("SYSTEM", layout='monadtall'),
          Group("FIREFOX", layout='monadtall'),
          Group("TELEGRAM", layout='monadtall'),
          Group("MISC", layout='monadtall'),
          Group("MISC", layout='monadtall'),
          Group("ARDOUR", layout='monadtall'),
          Group("ROUTING", layout='monadtall')]
